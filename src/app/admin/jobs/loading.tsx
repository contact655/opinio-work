        ...
        <div style={{ background: "#fff", border: "1px solid var(--line)", borderRadius: 12, overflow: "hidden" }}>
          ...
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} style={{
              ...
              <div>
                <div className="skeleton-shimmer" style={{ height: 14, width: 160, borderRadius: 4, marginBottom: 6 }} />
                <div className="skeleton-shimmer" style={{ height: 11, width: 100, borderRadius: 4 }} />
              </div>
