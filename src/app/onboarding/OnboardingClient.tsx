    ...
    <div style={pageWrap}>
      <div style={{ width: "100%", maxWidth: 480 }}>
        ...
        <div style={{
          ...
          {/*
            ★★公開範囲の説明（2026-09-09 に**位置を変えて戻した**）。

            ── 経緯 ────────────────────────────────────────────────────────────
            `00d10db6` で「その企業のページに『現役社員』として表示されます。見えるのは
            OPINIO にログインしている人だけです。」を外した。外した理由は
            **「入力欄のあいだに説明文が挟まって読みにくい」＝位置**であって、
            「見せない」という判断ではない。だから位置を変えて戻している。

            ⚠️★**入力欄ごとにバッジを散らさないこと。** セクションの見出し直下に
               **固定で1つ**だけ置く。2026-08-19 に「緑バッジと紫バッジが 1,138px 離れて
               同時に見えない」問題を踏んでいる。**距離が生まれる置き方をしない。**
          ...
          */}
          <p style={{
            ...
            borderRadius: 8, padding: "9px 11px", marginBottom: 20, lineHeight: 1.7,
          }}>
            選んだ会社の企業ページに、
