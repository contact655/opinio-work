...
export default function CareerAgentClient() {
            ...
            <div className="ca-form-col" style={{ flex: 1, maxWidth: 560 }}>
              {status === "done" ? (
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                  ...
                  <p style={{ fontSize: 11, color: "var(--ink-mute)", textAlign: "center", margin: 0, lineHeight: 1.7 }}>
                    送信することで
                    <Link href="/privacy" style={{ color: "var(--royal)", textDecoration: "underline" }}>プライバシーポリシー</Link>
                    に同意したものとみなします。
                  </p>
                </form>
              )}
