...
const ROLE_GUIDES = [
  /* ⚠️★年収レンジ（`salaryRange`）は 2026-09-01 に外した。**直書きの推測値だった。**
     ...
     ⚠️ 出典の無い数字は**的確表示義務**に関わる（出典なし求人13件を取り下げたのと同じ性質）。
        ⚠️★**「許可事業者だから」とは書かないこと**（2026-09-15 に訂正）。OPINIO は
           **募集情報等提供**（職安法4条6項）で、職業安定法の「求人等に関する情報の
           的確な表示」（5条の4）は**その立場のまま掛かる**。許可の有無と関係なく効く。
        ...
        <div style={{ marginBottom: 60, padding: "28px 24px", background: "var(--royal-50)", borderRadius: 18, border: "1px solid var(--royal-100)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(180px,1fr))", gap: 10 }}>
            {[
              ...
              { href: "/articles/type/career",   icon: "🌟", label: "キャリアの軌跡" },
