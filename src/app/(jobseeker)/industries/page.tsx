  ...
  return (
    <div style={{ background: "var(--bg-tint)", minHeight: "100vh" }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 820, margin: "0 auto", position: "relative" }} className="px-5 md:px-12">
          <div style={{
          ...
          <p style={{ fontSize: 15, color: "rgba(255,255,255,0.72)", lineHeight: 1.85, maxWidth: 520, margin: "0 0 20px" }}>
            OPINIOはIT/SaaS業界に特化したプラットフォームです。<br />
            以下の定義に沿った企業の求人・情報を掲載しています。
          </p>
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            {["B2B SaaS", "外資IT", "AI/ML", "クラウドインフラ"].map((tag) => (
              <span key={tag} style={{
