 ...
 *
 * ⚠️ 2026-08-05 時点、呼び出し元は0件。
 *    独立セクション（ProductPreview）→ HOW IT WORKS の2列グリッド → FV の検索窓直下、
 *    と置き場所が2度変わり、最後に FV を「見出し ＋ 検索窓」だけにする方針で外した。
 *    残しているのは、切り出し幅と表示幅の対応（下記）がこの部品に集約されており、
 *    実画面を再掲するときに同じ検証をやり直さずに済むため。
 *    使う画像と切り出し条件は LandingPage.tsx の冒頭コメントに記録してある。
 *
