        ...
        <div style={{ maxWidth: 780, margin: "0 auto", padding: "0 28px" }}>
          ...
          <div style={{ borderTop: `1px solid ${C.line}` }}>
            {[
              ...
              { q: "登録すると、スカウトが届きますか？", a: "登録しただけでは届きません。登録のあとに「転職について」を1問おたずねします。そこで「いまは声をかけられたくない」を選ぶと、企業の候補者検索にあなたは表示されません。答えるまでのあいだも届きません。答えはマイページの「意思表示」からいつでも変えられます。営業電話はありません。" },
