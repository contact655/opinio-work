 ...
 *    「求人票の向こうにいる現役社員」。片方だけ直すと対にならない。
 *    ⚠️ 2026-09-20 に差し替えた。**体言止めになったので、受ける文も変えてある**
 *       （「…で『◯◯』」では文にならない）。
 *
            ...
            <div className="lpv3-fv">
              <div>
                ...
                {/* ⚠️★かぎかっこの中はトップページの h1 と完全一致。片方だけ直さないこと。
                       ⚠️ 2026-09-20 に h1 が体言止めになったので、受ける文を
                          「…を見ています」に変えた。**かぎかっこの中は足さない・削らない。** */}
                <p className="lpv3-echo">
                  求職者は、OPINIOで<b>「求人票の向こうにいる現役社員」</b>を見ています。
                </p>
              </div>
