...
export async function PUT(req: Request) {
  ...
  if (typeof body.years_of_experience === "number" && Number.isFinite(body.years_of_experience)) {
    payload.years_of_experience = Math.max(0, Math.min(Math.floor(body.years_of_experience), 60));
  }
