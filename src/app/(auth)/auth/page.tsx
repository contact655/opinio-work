          ...
          {mode === "signup" && (
            <>
              ...
              <form onSubmit={handleSignup}>
                ...
                {/*
                  スカウトの初期値の告知。
                  ⚠️ `ow_profiles.scout_enabled` の既定は `true`。**既定でオンにする以上、
                     登録時点で知らせないと「黙って設定された」ことになる。消さないこと。**
                  ⚠️ 利用規約 第8条が「初期設定は『受け取る』とし、登録手続の画面で明示する」と
                     定めている（2026-08-21 改定）。**この一文がその「明示」にあたる。**
                     既定値を変えるなら規約とこの一文を同時に直すこと。
                ...
                */}
                <p style={{ fontSize: 12, color: "var(--ink-mute)", fontWeight: 500, textAlign: "center", lineHeight: 1.8, marginTop: 6 }}>
                  登録すると、企業からスカウトを受け取る設定になります。マイページの「声をかけられてもよいか」からいつでも変更できます。
                </p>
                {/*
