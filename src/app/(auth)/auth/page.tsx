              ...
              <form onSubmit={handleSignup}>
                ...
                */}
                ...
                {/*
                  ...
                  ⚠️★**内容が消えたわけではない。** 同じことを言う場所が3つ残っている:
                       ① LP の FAQ「登録すると、スカウトが届きますか？」（LandingPage.tsx）
                  ...
                  ⚠️★**「現在準備中」だけは②に無い。** 残っているのは①の FAQ だけ。
                     **再開するとき（`SCOUT_SENDING_ENABLED=true`）に消すのは LP の FAQ の1箇所。**
