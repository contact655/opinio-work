...
export const MOCK_USER = {
  name: "田中 翔太",
  initial: "田",
  avatarGradient: "linear-gradient(135deg, var(--royal), #3B5FD9)",
  coverGradient: "linear-gradient(135deg, var(--royal), #3B5FD9, #818CF8)",
...
export const MOCK_CASUAL_MEETINGS: CasualMeeting[] = [
  {
    ...
    company_initial: "L",
    company_gradient: "linear-gradient(135deg, #1E40AF, var(--royal))",
...
export const MOCK_RECEIVED_REQUESTS: ReceivedRequest[] = [
  ...
  },
  {
    ...
    requester_initial: "田",
    requester_gradient: "linear-gradient(135deg, var(--royal), #3B5FD9)",
  ...
  },
  {
    ...
    requester_initial: "佐",
    requester_gradient: "linear-gradient(135deg, #34D399, var(--success))",
    requester_role: "PdM",
