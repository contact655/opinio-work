...
5. ★**入社理由を本人に確認する**（2026-09-11 追加）
   ⚠️★**この人の職歴3件には、運営が履歴書から書き起こした入社理由が入っている。**
      本人が書いたものではない。**残すか消すかを本人に決めてもらうこと。**
   ⚠️ 2026-09-11 に**3件とも `visibility_reason = false`（出さない）に倒してある**ので、
      登録しても**そのままでは出ない**。本人が職歴の編集画面でトグルをオンにして初めて出る。
      ⇒ **順序を間違えて先に描画だけ入れると、本人が書いていない文章が本人名義で公開される**
        という事故は、この手順で防いである。
